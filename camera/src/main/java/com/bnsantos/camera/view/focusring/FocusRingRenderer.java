...
import com.bnsantos.camera.view.animation.DynamicAnimation;
import com.bnsantos.camera.view.unit.UnitCurve;
import com.bnsantos.camera.view.unit.UnitCurves;
...
abstract class FocusRingRenderer implements DynamicAnimation {
  private static final String TAG = new String("FocusRingRenderer");
